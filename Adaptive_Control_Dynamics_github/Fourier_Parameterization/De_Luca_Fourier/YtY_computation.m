...
syms t a_1 a_2 b_1 b_2 q0_1 q0_2 wf real;

l=1; %% 1st harmonic
% wf = 0.15*pi; % fundamental pulsation of the Fourier series

q1 = (a_1/l*wf)*sin(l*wf*t) - (b_1/l*wf)*cos(l*wf*t) + q0_1;
q2 = (a_2/l*wf)*sin(l*wf*t) - (b_2/l*wf)*cos(l*wf*t) + q0_2;
q = [q1; q2];
...
f =  matlabFunction(YtY , 'File', 'RR_regressor_YtY', ...
    'Outputs', {'YtY'},'Vars',[a_1 a_2 b_1 b_2 q0_1 q0_2 wf gy t]);
